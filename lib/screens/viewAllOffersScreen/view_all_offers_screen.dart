...
class ViewAllOffersScreen extends StatefulWidget {
  const ViewAllOffersScreen({Key? key}) : super(key: key);
          ...
          child: Stack(
            children: [
              ...
              Visibility(
                  ...
                  child: Center(child: Text("No data is available !",style: GoogleFonts.nunito(
                      fontSize: 18
                  ),))),
            ],
          ),
  ...
  Widget offersList(int index, ViewAllOffersProvider viewAllOffersProvider) {
    return Container(
        ...
        child: Column(
          ...
          children: [
            Image.network(AppConstants.OFFER_IMAGE_URL+"1"+"_M.png",fit: BoxFit.fill,height: 150,width: MediaQuery.of(context).size.width,),
            // // Text(
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.pop(context, viewAllOffersProvider.offersList[index].couponid.toString());
