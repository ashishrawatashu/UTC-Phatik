...
import '../../arguments/cancel_ticket_deatils_screen_arguments.dart';
...
class _ActiveBookingScreenState extends State<ActiveBookingScreen> {
  ...
  late ActiveBookingScreenProvider _activeBookingScreenProvider;

  @override
  void initState() {
    super.initState();
    _activeBookingScreenProvider = Provider.of<ActiveBookingScreenProvider>(context, listen: false);
    _activeBookingScreenProvider.getAllTickets.clear();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Active bookings",style: GoogleFonts.nunito(fontSize: 18),),
      ),
      body: Container(
        color: HexColor(MyColors.homegrey),
        child:activeBookingsBody(),
      ),
    );
  }
  ...
  activeBookingsBody() {
    return Consumer<ActiveBookingScreenProvider>(
        builder: (_, activeBookingProvider, __) {
          return Stack(
            children: [
              Visibility(
                  visible: activeBookingProvider.isLoading?true:false,
                  child: CommonWidgets.buildCircularProgressIndicatorWidget()),
              Visibility(
                  visible: activeBookingProvider.isLoading?false:true,
                  child: activeBookingListBuilder(activeBookingProvider)),
              Visibility(
                  visible: checkData(activeBookingProvider),
  ...
  checkData(ActiveBookingScreenProvider activeBookingProvider) {
    if(activeBookingProvider.isLoading&&activeBookingProvider.getAllTickets.isEmpty){
      return false;
    }else if (activeBookingProvider.isLoading==false&&activeBookingProvider.getAllTickets.isEmpty){
      return true;
    }else{
      return false;
    }
  ...
  showTicketDiloag(ActiveBookingScreenProvider activeBookingScreenProvider, int index) {
    showDialog(
        context: context,
              ...
              child: Column(
                children: [
                  TicketWidget(
                    ...
                    child: Container(
                      child: ticketData(activeBookingScreenProvider,index),
                    ),
                  ),
                ],
              ),
  ...
  ticketData(ActiveBookingScreenProvider activeBookingScreenProvider, int index) {
    return Column(
      ...
      children: [
                  ...
                  children: [
                    Expanded(
                        ...
                        child: Container(
                            ...
                            child: Text(activeBookingScreenProvider.passengerConfirmDetailsResponse.ticketDeatil![0].source.toString(),
                    ...
                    Expanded(
                        ...
                        child: Container(
                            ...
                            padding: EdgeInsets.only(left: 10),
                            margin: EdgeInsets.only(right: 10),
                            child: Text(activeBookingScreenProvider.passengerConfirmDetailsResponse.ticketDeatil![0].destination.toString(),
                                style: GoogleFonts.nunito(
                                    fontSize: 12,
                                    color: HexColor(MyColors.black),
                                    fontWeight: FontWeight.bold)))),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                activeBookingScreenProvider.concatSeatsNumber(),
                style: GoogleFonts.nunito(
                    fontSize: 16,
                    color: HexColor(MyColors.black),
                    fontWeight: FontWeight.w600),
        ...
        ticketCenterLine(),
        fareSummary(activeBookingScreenProvider),
        Center(
          child: GestureDetector(
            onTap: () async {
              Navigator.pop(context);
              final bytes = utf8.encode(activeBookingScreenProvider.passengerConfirmDetailsResponse.ticketDeatil![0].ticketno.toString());
  ...
  fareSummary(ActiveBookingScreenProvider activeBookingScreenProvider) {
    return Container(
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Text(
                  "₹ " + activeBookingScreenProvider.passengerConfirmDetailsResponse.ticketFare![0].totalfareamt.toString(),
                  style: GoogleFonts.nunito(
                      color: HexColor(MyColors.black),
                      fontWeight: FontWeight.w600,
                      fontSize: 16),
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  "₹ " + activeBookingScreenProvider.passengerConfirmDetailsResponse.ticketFare![0].busrescharges.toString(),
                  style: GoogleFonts.nunito(
                      color: HexColor(MyColors.black),
                      fontWeight: FontWeight.w600,
                      fontSize: 16),
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  "₹ " + activeBookingScreenProvider.passengerConfirmDetailsResponse.ticketFare![0].totaltax.toString(),
                  style: GoogleFonts.nunito(
                      color: HexColor(MyColors.black),
                      fontWeight: FontWeight.w600,
                      fontSize: 16),
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  "₹ " + activeBookingScreenProvider.passengerConfirmDetailsResponse.ticketFare![0].totconsessionamt.toString(),
                  style: GoogleFonts.nunito(
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    "₹ " + activeBookingScreenProvider.passengerConfirmDetailsResponse.ticketFare![0].netfare.toString(),
                    style: GoogleFonts.nunito(
                        color: HexColor(MyColors.green),
                        fontWeight: FontWeight.w700,
                        fontSize: 22),
  ...
  ticketCenterLine() {
    return Container(
      child: Container(
        ...
        height: 150,
        child: QrImage(
          data: _activeBookingScreenProvider.qrTextEncrypt,
  ...
  showQrCodeDilaog(ActiveBookingScreenProvider activeBookingScreenProvider, int index) async {
    CommonMethods.showLoadingDialog(context);
    await activeBookingScreenProvider.getQrTextEn(activeBookingScreenProvider.getAllTickets[index].ticketno.toString());
    await activeBookingScreenProvider.getPassengerConfirmationDetails(activeBookingScreenProvider.getAllTickets[index].ticketno.toString());
    Navigator.pop(context);
    if (activeBookingScreenProvider.passengerConfirmDetailsResponse.code == "100") {
      if (activeBookingScreenProvider.getQrTextEnResponse.code == "101") {
        showTicketDiloag(activeBookingScreenProvider, index);
      } else {
        CommonMethods.showSnackBar(context, "Something went wrong ....");
      }
    } else if (activeBookingScreenProvider.passengerConfirmDetailsResponse.code == "999") {
      CommonMethods.showTokenExpireDialog(context);
    } else if (activeBookingScreenProvider.passengerConfirmDetailsResponse.code == "900") {
  ...
  activeBookingListBuilder(ActiveBookingScreenProvider activeBookingProvider) {
    return  ListView.builder(
      padding: EdgeInsets.zero,
      itemCount: activeBookingProvider.getAllTickets.length,
      // itemCount: 10,
      itemBuilder: (BuildContext context, int index) {
        // return activeBookingListItems(index,activeBookingProvider);
        return activeBookingNewListItems(index,activeBookingProvider);
      },
    );
  }

  activeBookingListItems(int index, ActiveBookingScreenProvider activeBookingProvider) {
          ...
          Expanded(
            ...
            child: Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("PNR: "+activeBookingProvider.getAllTickets[index].ticketno!,style: GoogleFonts.nunito(fontSize: 15),),
                    Row(
                      children: [
                        Container(
                          height: 50,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text(activeBookingProvider.getAllTickets[index].source!,style: GoogleFonts.nunito(color: HexColor(MyColors.black),fontSize: 14,fontWeight: FontWeight.bold),),
                              Text(activeBookingProvider.getAllTickets[index].destination!,style: GoogleFonts.nunito(color: HexColor(MyColors.black),fontSize: 14,fontWeight: FontWeight.bold),),
                            ],
                          ),
                        )
                      ],
                    ...
                    Row(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(activeBookingProvider.getAllTickets[index].servicetypenameen!,style: GoogleFonts.nunito(fontSize: 14),),
                        ),
                      ],
                    ),
                    Row(
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(top: 8.0),
                          child: Text(activeBookingProvider.getAllTickets[index].journeydate!, style: GoogleFonts.nunito(
                            fontSize: 14,
                            color: HexColor(MyColors.black),),),
                        ),
                      ],
                    ...
                    Row(
                      children: [
                        Container(
                          margin : EdgeInsets.only(left: 8,right: 8,top: 8),
                          child: Image.asset("assets/images/confirm_status.png",height: 18,width: 18),
                        ),
                        Padding(
                          padding: const EdgeInsets.only(top: 8.0),
                          child: Text("Confirmed",style: GoogleFonts.nunito(fontSize: 16,color: HexColor(MyColors.green),fontWeight: FontWeight.bold),),
                        ),
                      ],
                    ),
                  ],
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Visibility(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          ...
                          //     arguments: PaymentScreenArguments(_activeBookingScreenProvider.ticketsResponse.tickets![index].ticketno!,"BookingTab")).then((value) => _activeBookingScreenProvider.getTickets());
                          moveToCancelTicketDetailsScreen(activeBookingProvider,index);
                        },
                        child: Container(
                          decoration: BoxDecoration(
                            // color: HexColor(MyColors.grey1),
                  ...
                  Expanded(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        showQrCodeDilaog(activeBookingProvider, index);
                      },
                      child: Container(
                        decoration: BoxDecoration(
                          // color: HexColor(MyColors.green),
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Navigator.pushNamed(
                            ...
                            arguments: PaymentScreenArguments(activeBookingProvider.getAllTickets[index].ticketno!,"BookingTab"));
  ...
  void moveToCancelTicketDetailsScreen(ActiveBookingScreenProvider activeBookingProvider, int index) {
    Navigator.pushNamed(context, MyRoutes.cancelTicketsScreen,
        arguments:  CancelTicketsScreenDetailsArguments(
            activeBookingProvider.getAllTickets[index].ticketno!,
            activeBookingProvider.getAllTickets[index].source!,
            activeBookingProvider.getAllTickets[index].destination!,
            activeBookingProvider.getAllTickets[index].destination!,
            activeBookingProvider.getAllTickets[index].journeydate!,
            activeBookingProvider.getAllTickets[index].servicetypenameen!,
            activeBookingProvider.getAllTickets[index].deptitme!,
            activeBookingProvider.getAllTickets[index].arrival!)).then((value) => checkTicketsForRating(activeBookingProvider));

  }

  checkTicketsForRating(ActiveBookingScreenProvider activeBookingProvider) {
    activeBookingProvider.getAllTickets.clear();
    activeBookingProvider.getConfirmsTickets();
  }

  void getActiveTickets() async {
    if (await CommonMethods.getInternetUsingInternetConnectivity()) {
    await _activeBookingScreenProvider.authenticationMethod();
    _activeBookingScreenProvider.getConfirmsTickets();
  ...
  activeBookingNewListItems(int index, ActiveBookingScreenProvider activeBookingProvider) {
    return Card(
      elevation: 2,
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text(activeBookingProvider.getAllTickets[index].source!,style: GoogleFonts.nunito(color: HexColor(MyColors.black),fontSize: 14,fontWeight: FontWeight.w600),),
                              Text(activeBookingProvider.getAllTickets[index].destination!,style: GoogleFonts.nunito(color: HexColor(MyColors.black),fontSize: 14,fontWeight: FontWeight.w600),),
                            ],
                          ),
                        )
                      ],
